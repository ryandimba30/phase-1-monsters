...
function createForm() {
    ...
    const addName = document.querySelector('#name-input').value
    const addAge = document.querySelector('#age-input').value
    const addBio = document.querySelector('#bio-input').value
